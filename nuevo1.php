...
<body class="bg-dark">
    <div class="container">
        <h2 class="text-center text-danger">Registro Computadoras</h2>
        <div class="card">
            <div class="card-body border border-success">
        <form action="insertar1.php" method="POST" class="row">
        ...
        <div class="col-6 text-center p-3">
            ...
            <input type="text" class="form-control" name="txtli" id=""  placeholder="" required>
        ...
        <a class="btn btn-warning" href="listado1.php">VOLVER</a>
        <div>
